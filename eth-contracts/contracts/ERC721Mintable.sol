...
contract Pausable is Ownable {
	...
	function setPausable(bool paused) public onlyOwner {
		_paused = paused;
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(ownerOf(tokenId) != to, "Given address is owner of tokenID");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        address contractOwner = ownerOf(tokenId);
        require(contractOwner == msg.sender || isApprovedForAll(contractOwner, msg.sender ));

        // TODO add 'to' address to token approvals
        _tokenApprovals[tokenId] = to;

        // TODO emit Approval Event
		emit Approval(contractOwner, msg.sender, tokenId);
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(_exists(tokenId) == false, "Given TokenID already exists");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "Address is not owner of given token");
...
contract CustomERC721Token is ERC721Metadata('Dunphy Properties', 'Dunphy', 'https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/'){
    constructor() public {
    }
